...
/* #G, Dividi per tre e per step di 2 tutti i numeri primi che seguono, 3+2, 5+2, 7+2...
    ...
    $d * $d <= $numero (ottimizzazione) sta a significare: cerca fino al punto
    dove il divisore moltiplicato per se stesso non supera il numero,
    non serve cercarli tutti.
